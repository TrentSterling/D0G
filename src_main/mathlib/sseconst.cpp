...
#ifdef __ARM_NEON__
const u32x4 g_SIMD_clear_signmask_NEON = {0x7fffffff, 0x7fffffff, 0x7fffffff, 0x7fffffff};
const u32x4 g_SIMD_signmask_NEON = {0x80000000, 0x80000000, 0x80000000, 0x80000000};
const u32x4 g_SIMD_lsbmask_NEON = {0xfffffffe, 0xfffffffe, 0xfffffffe, 0xfffffffe};
const u32x4 g_SIMD_clear_wmask_NEON = {0xffffffff, 0xffffffff, 0xffffffff, 0};

const u32x4 g_SIMD_ComponentMask_NEON[4] =
{
	{0xffffffff, 0, 0, 0}, {0, 0xffffffff, 0, 0}, {0, 0, 0xffffffff, 0}, {0, 0, 0, 0xffffffff}
};

const i32x4 g_SIMD_signshift_NEON = {-31, -30, -29, -28};
#endif
