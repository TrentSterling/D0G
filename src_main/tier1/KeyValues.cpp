...
static const char *s_LastFileLoadingFromUnknown = "unknown";
static char *s_LastFileLoadingFrom = (char *)(s_LastFileLoadingFromUnknown); // just needed for error messages
