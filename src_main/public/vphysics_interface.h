...
#ifdef __ANDROID__
#define VPHYSICS_V29_BACKPORT 1
#endif
...
#ifdef VPHYSICS_V29_BACKPORT
	virtual void MaxSpeed( const Vector &maxSpeed, const AngularImpulse &maxAngularSpeed ) = 0;
...
#ifdef VPHYSICS_V29_BACKPORT
	virtual void GetMaxSpeed( Vector *pMaxSpeedOut, AngularImpulse *pMaxAngularSpeedOut ) = 0;
#else
...
#ifdef VPHYSICS_V29_BACKPORT
	surfacesoundnames_t		soundCounts; // counts of linked sounds
#endif
