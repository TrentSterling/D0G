...
public:
...
#ifdef __ANDROID__
	// Operating with VMatrices directly because there are no matrix stacks in OES2.
	virtual void LoadMatrix(const VMatrix &m) = 0;
	virtual void MultMatrix(const VMatrix &m) = 0;
	virtual void MultMatrixLocal(const VMatrix &m) = 0;
	virtual void GetMatrix(MaterialMatrixMode_t matrixMode, VMatrix &dst) = 0;
#else
...
#ifdef __ANDROID__
	virtual void SetPixelShaderStateAmbientLightCube(int pshRegX, int pshRegY, int pshRegZ, bool bForceToBlack = false) = 0;
	...
	virtual void Uniform1fv(int location, unsigned int count, const float *value) = 0;
	virtual void Uniform2fv(int location, unsigned int count, const float *value) = 0;
	virtual void Uniform3fv(int location, unsigned int count, const float *value) = 0;
	virtual void Uniform4fv(int location, unsigned int count, const float *value) = 0;
	virtual void UniformMatrix2fv(int location, unsigned int count, const float *value) = 0;
	virtual void UniformMatrix3fv(int location, unsigned int count, const float *value) = 0;
	virtual void UniformMatrix4fv(int location, unsigned int count, const float *value) = 0;
#endif
};
