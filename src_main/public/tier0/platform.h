...
inline void SetupFPUControlWord()
{
	...
	__asm__ __volatile__ (
		...
		"orr %r0, %r0, #0x1800\n" // Mask only inexact and underflow
		"vmsr fpscr, %r0\n"       // Put the new control word in the FPU
		: "+r" (cw)
	);
}
...
#define WordSwap  WordSwapARM
#define DWordSwap DWordSwapARM
...
struct CPUInformation
{
	...
	bool m_bRDTSC : 1,	// Is RDTSC supported?
		 ...
		 m_bSSE	  : 1,	// On x86: Is SSE supported? On ARM: Is NEON supported?
