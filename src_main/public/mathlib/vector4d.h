...
#endif
#elif defined( _X360 )
#include <xboxmath.h>	// For AltiVec
#else
...
public:
	...
	inline const __vector4 &AsM128() {return *((const __vector4 *)(&x));}
#else
...
#if defined(__ARM_NEON__)
	float32x4_t temp = vdupq_n_f32(w);
	vOutA.AsM128() = vmlaq_f32(vOutA.AsM128(), vInA.AsM128(), temp);
	vOutB.AsM128() = vmlaq_f32(vOutB.AsM128(), vInB.AsM128(), temp);
#elif defined( _X360 )
    __vector4 temp;
