...
#define IVP_RAYCAST_AIRBOAT_STEERING_RATE		0.0018f

#define IVP_RAYCAST_AIRBOAT_THRUST_MAX_REVERSE	7.5f		// N
#define IVP_RAYCAST_AIRBOAT_THRUST_MAX			11.0f		// N
...
public:
	...
	IVP_FLOAT			flWaterDepth;						// Water depth at impact point.
	int					surfaceProps;
};
...
public:
    ...
    /**** Methods: 2nd Level, based on primitives ****/
    virtual void					do_steering(IVP_FLOAT steering_angle_in, IVP_BOOL analog_steering);					// default implementation updates this->steering_angle
...
protected:
	...
	// Speed.
    IVP_FLOAT						max_speed;
	IVP_U_Float_Point				m_LocalVelocity;
	...
	IVP_FLOAT						m_LastForwardSteeringAngle;
	IVP_FLOAT						m_SteeringSpeed;
	IVP_BOOL						m_bReverseSteering;
	IVP_BOOL						m_bAnalogSteering;

	// Thrust.
	IVP_FLOAT						m_flThrust;

	// Airborne state.
	IVP_BOOL						m_bAirborne;
	IVP_FLOAT						m_flAirborneTime;
	IVP_BOOL						m_bAirborneIdle;

	// Keep upright.
	IVP_FLOAT						m_flKeepUprightPitch;
	IVP_FLOAT						m_flKeepUprightRoll;
...
protected: 
	...
	virtual void DoSimulationDrag( IVP_Raycast_Airboat_Pontoon_Temp *pTempPontoons, IVP_Raycast_Airboat_Impact *pImpacts, IVP_Event_Sim *pEventSim ) = 0;
...
private:
	...
	bool							PostRaycasts( IVP_Ray_Solver_Template *pRaySolverTemplates, const IVP_U_Matrix *matWorldFromCore, IVP_Raycast_Airboat_Pontoon_Temp *pTempPontoons, IVP_Raycast_Airboat_Impact *pImpacts );

	// Simulation.
	void							DoSimulationPontoons( IVP_Raycast_Airboat_Pontoon_Temp *pTempPontoons, IVP_Raycast_Airboat_Impact *pImpacts, IVP_Event_Sim *pEventSim );
	void							DoSimulationPontoonsGround( IVP_Raycast_Airboat_Wheel *pPontoonPoint, IVP_Raycast_Airboat_Pontoon_Temp *pTempPontoon, IVP_Raycast_Airboat_Impact *pImpact, IVP_Event_Sim *pEventSim );
	void							DoSimulationPontoonsWater( IVP_Raycast_Airboat_Pontoon_Temp *pTempPontoon, IVP_Raycast_Airboat_Impact *pImpact, IVP_Event_Sim *pEventSim );
