...
#ifdef __ANDROID__
	virtual int MaxCubeMapTextureSize(void) const { return 0; }
	virtual int NumPixelShaderInputs(void) const { return 0; }
	virtual int MaxRenderTargetSize(void) const { return 0; }
#endif
};
